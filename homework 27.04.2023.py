...
# lenA = int(input('Введите длину массива: '))
# A = [int(input(f'Введите элемент массива {i}: ')) for i in range(lenA)]
# num = int(input('Введите искомое число: '))
# count = 0
# for i in range(lenA):
#     if A[i] == num:
#         count += 1
# print(f'Число {num} в данном массиве встречается {count} раз(а).')
...
#     if abs(A[i] - X) < count:
#         count = abs(A[i] - X)
# print(f'Самый близкий по величине элемент равен {nearest}')
...
# scr_dict = {'a': 1, 'e': 1, 'i': 1, 'o': 1, 'u': 1, 'l': 1, 'n': 1, 's': 1, 't': 1, 'r': 1, 'd': 2,
...
#     count += scr_dict[word[i]]
# print(f'Стоимость введенного слова равна {count}')
